...
static struct cpufreq_dvfs dvfs_table[] = {
    ...
    {.freq = 1056000000, .volt = 1475}, /* core vdd is 1.50v if cpu frequency is (1008Mhz, xxxxMhz] */
...
static unsigned int last_vdd    = 1450;     /* backup last target voltage, default is 1.4v  */
#endif
